...
public class Places {
	...
	public Places(Long id, String name, String bestTime, String location, String description,
			List<PicturesPlace> picturesPlace, Category category, List<Comments> comms, Set<Users> users) {
		super();
		this.id = id;
		this.name = name;

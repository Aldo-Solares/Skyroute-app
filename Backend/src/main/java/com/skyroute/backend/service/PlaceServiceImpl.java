...
public class PlaceServiceImpl implements PlaceService {
	...
	public PlaceRecord updatePlace(PlaceRecord place, List<MultipartFile> files, String catName, String originalName) {
		...
		Places existing = placeRepo.findByName(originalName)
	...
	public List<PlaceRecord> getAllByName() {
		...
		List<Places> places = placeRepo.findAll();
	...
	public List<PlaceRecord> getAllByNameCat(String categoryName, String userName) {
		...
		List<Places> places = placeRepo.findByCategory_CategoryName(categoryName);
	...
	// SAVE FILES
	// =========================
	private List<PicturesPlace> saveFiles(List<MultipartFile> files, Places place) {

...
import com.skyroute.backend.config.JwtService;
import com.skyroute.backend.exceptions.PasswordException;
import com.skyroute.backend.model.Users;
import com.skyroute.backend.records.ChangePasswordRecord;
import com.skyroute.backend.records.UserRequestRecord;
import com.skyroute.backend.records.UserResponseRecord;
import com.skyroute.backend.service.UserService;
import com.skyroute.backend.wrappers.JwtResponse;
...
public class AuthController {
	...
	public ResponseEntity<Object> login(@RequestBody UserRequestRecord user) {
		...
		try {
			...
			Users userRes = userService.findByUsername(user.username())
					.orElseThrow();
